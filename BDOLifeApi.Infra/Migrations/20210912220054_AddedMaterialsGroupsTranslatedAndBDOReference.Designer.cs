...
namespace BDOLife.Infra.Migrations
{
    ...
    [Migration("20210912220054_AddedMaterialsGroupsTranslatedAndBDOReference")]
    partial class AddedMaterialsGroupsTranslatedAndBDOReference
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BDOLife.Core.Entities.MaterialGroupTranslate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MaterialGroupTranslate");
                });
            ...
            modelBuilder.Entity("BDOLife.Core.Entities.MaterialGroupTranslate", b =>
                {
                    b.HasOne("BDOLife.Core.Entities.MaterialGroup", "MaterialGroup")
                        .WithMany("Translates")
                        .HasForeignKey("MaterialGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
